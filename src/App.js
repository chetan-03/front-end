...
function App() {
  ...
  return (
    <div>
      { apiData && apiData.map(function (e) {
        return <div style={ {
          display: 'flex',
          ...
          <Card title={ e.title }
            ...
            earliest_shipping={ e.earliest_shipping }
            rating={ e.rating }
            discount={ e.discount }
            id={ e.id }
            key={ e.id }
